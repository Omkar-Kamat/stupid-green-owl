...
const ERROR_MESSAGES: Record<string, string> = {
  ...
  ATTEMPT_FORBIDDEN: "You cannot access this lesson attempt.",
  ...
  EXERCISE_NOT_IN_LESSON: "That exercise does not belong to this lesson.",
  LESSON_INCOMPLETE: "Finish all exercises before completing the lesson.",
  LESSON_HAS_NO_EXERCISES: "This lesson has no exercises yet.",
  ...
  UNSUPPORTED_EXERCISE_TYPE: "This exercise type is not supported.",
  CORRUPTED_LESSON_STATE: "Lesson data is inconsistent. Please try again.",
  CORRUPTED_USER_STATS: "Your profile data is inconsistent. Please try again.",

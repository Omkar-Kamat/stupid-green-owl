...
export function MainHero() {
  return (
    <section className="flex flex-1 flex-col bg-white">
      <div className="mx-auto flex flex-1 max-w-[1080px] flex-col items-center justify-center gap-8 px-6 py-12 md:flex-row md:gap-12 md:px-10 md:py-16">
        <div className="flex-1">
          <MainHeroIllustration />
        </div>

        <div className="flex flex-1 flex-col items-center gap-6 md:items-start">
          <h1 className="text-center text-[32px] font-extrabold leading-tight text-duo-gray md:text-left md:text-[40px]">
